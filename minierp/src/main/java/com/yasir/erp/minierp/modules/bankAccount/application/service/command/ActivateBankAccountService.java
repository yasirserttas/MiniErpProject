...
import com.yasir.erp.minierp.modules.bankAccount.domain.port.inbound.command.ActivateBankAccountUseCase;
...
@Service
public class ActivateBankAccountService implements ActivateBankAccountUseCase {
    ...
    public ActivateBankAccountService(BankAccountCommandPort commandPort,
    ...
    public BankAccountDto activate(String accountId) {
        BankAccount existing =
                byIdAndStatusPort.findByIdAndStatus(accountId, BankAccountStatus.PASSIVE)
