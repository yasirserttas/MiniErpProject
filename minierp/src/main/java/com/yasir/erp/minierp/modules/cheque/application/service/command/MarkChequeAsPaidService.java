...
import com.yasir.erp.minierp.modules.cheque.domain.port.inbound.command.MarkChequeAsPaidUseCase;
...
@Service
public class MarkChequeAsPaidService implements MarkChequeAsPaidUseCase {
    ...
    public MarkChequeAsPaidService(ChequeCommandPort commandPort,
    ...
    public ChequeDto markAsPaid(String chequeId) {
        ...
        addBankMovementUseCase.addBankMovement(new CreateBankMovementDtoRequest(
                ...
                "Paid outgoing cheque: " + existing.getChequeNumber()
        ));
