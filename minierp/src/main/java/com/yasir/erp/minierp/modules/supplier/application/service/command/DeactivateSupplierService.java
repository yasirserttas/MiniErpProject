...
@Service
public class DeactivateSupplierService implements DeactivateSupplierUseCase {
    ...
    public DeactivateSupplierService(SupplierCommandPort commandPort,
    ...
    public SupplierDto deactivateSupplier(String supplierId)
    {
        Supplier existing = byIdAndActivePort.findByIdAndActive(supplierId, true)
