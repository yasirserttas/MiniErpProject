...
public class CancelDispatchNoteService implements CancelDispatchNoteUseCase {
    ...
    public CancelDispatchNoteService(DispatchNoteCommandPort commandPort,
    ...
    @Override
    public DispatchNoteDto cancelDispatchNote(String dispatchNoteId) {
