...
import com.yasir.erp.minierp.modules.dispatchNote.domain.port.inbound.command.DeactivateDispatchNoteUseCase;
...
public class DeactivateDispatchNoteService implements DeactivateDispatchNoteUseCase {
    ...
    public DeactivateDispatchNoteService(DispatchNoteCommandPort commandPort,
    ...
    @Override
    public DispatchNoteDto deactivateDispatchNote(String dispatchNoteId) {
